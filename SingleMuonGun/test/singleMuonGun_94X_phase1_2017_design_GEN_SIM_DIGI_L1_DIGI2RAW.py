...
# with command line options: SingleMuPt10_pythia8_cfi --conditions auto:phase1_2017_design -n 10 --eventcontent RAWSIM -s GEN,SIM,DIGI,L1,DIGI2RAW --datatier GEN-SIM-RAW --era Run2_2017 --beamspot GaussSigmaZ4cm --geometry DB:Extended --fileout file:step1.root --no_exec
