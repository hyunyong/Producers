...
# with command line options: SingleMuPt10_pythia8_cfi --conditions 102X_postLS2_design_v7 -n 10 --era Run3 -s GEN,SIM,DIGI:pdigi_valid,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO --beamspot GaussSigmaZ4cm --geometry Extended2019
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SingleMuPt10_pythia8_cfi_GEN_SIM_DIGI_L1_DIGI2RAW_RAW2DIGI_L1Reco_RECO.root'),
