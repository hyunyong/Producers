...
# with command line options: step2 --conditions auto:phase1_2017_design -n 10 --eventcontent RECOSIM -s RAW2DIGI,RECO --datatier RECO --era Run2_2017 --beamspot GaussSigmaZ4cm --geometry DB:Extended --fileout file:step1.root --no_exec
